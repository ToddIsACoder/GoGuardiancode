! function(t) {
                                ...
                                return function t(e, r, n) {
                                        ...
                                        23: [function(t, r, n) {
                                                ...
                                                r.exports = function() {
                                                        ...
                                                        F.RangeError = l.RangeError, F.CancellationError = l.CancellationError, F.TimeoutError = l.TimeoutError, F.OperationalError = l.OperationalError, F.RejectionError = l.OperationalError, F.AggregateError = l.AggregateError;
                                                        var h = function() {},
                                                                f = {},
                                                                d = {
                                                                        e: null
                                                        ...
                                                        function F(t) {
                                                                ...
                                                                if (this.constructor !== F) throw new p("the promise constructor cannot be invoked directly\n\n    See http://goo.gl/KsIlge\n");
                                                        ...
                                                        return F.prototype.toString = function() {
                                                                ...
                                                                if (e > 1) {
                                                                        ...
                                                                        for (r = 0; r < e - 1; ++r) {
                                                                                var o = arguments[r];
                                                                                if ("function" != typeof o) return F.reject(new p("Catch filter must inherit from Error or be a simple predicate function\n\n    See http://goo.gl/o84o68\n"));
                                                                                n[i++] = o
                                                                        }
                                                        ...
                                                        }, F.getNewLibraryCopy = r.exports, F.is = function(t) {
                                                        ...
                                                        }, F.prototype._isFollowingOrFulfilledOrRejected = function() {
                                                                ...
                                                                var t = this._boundTo;
                                                                return void 0 !== t && t instanceof F ? t.isFulfilled() ? t.value() : void 0 : t
                                                                ...
                                                                var r = t._fulfillmentHandlerAt(e),
                                                                        ...
                                                                        o = t._promiseAt(e),
                                                                        s = t._receiverAt(e);
                                                                o instanceof F && o._setIsMigrated(), void 0 === s && (s = c), this._addCallbacks(r, n, i, o, s, null)
                                                        ...
                                                        }, F.prototype._settlePromiseFromHandler = function(t, e, r, n) {
                                                                var o;
                                                                if (!n._isRejected())
                                                                        if (n._pushContext(), o = e !== f || this._isRejected() ? E(t).call(e, r) : E(t).apply(this._boundValue(), r), n._popContext(), o === k || o === n || o === d) {
                                                                                var s = o === n ? i() : o.e;
                                                        ...
                                                        }, a.notEnumerableProp(F, "_makeSelfResolutionError", i), t("./progress.js")(F, g), t("./method.js")(F, h, _, s), t("./bind.js")(F, h, _), t("./finally.js")(F, d, _), t("./direct_resolve.js")(F), t("./synchronous_inspection.js")(F), t("./join.js")(F, g, _, h), F.version = "2.11.0", F.Promise = F, t("./map.js")(F, g, s, _, h), t("./cancel.js")(F), t("./using.js")(F, s, _, m), t("./generators.js")(F, s, h, _), t("./nodeify.js")(F), t("./call_get.js")(F), t("./props.js")(F, g, _, s), t("./race.js")(F, h, _, s), t("./reduce.js")(F, g, s, _, h), t("./settle.js")(F, g), t("./some.js")(F, g, s), t("./promisify.js")(F, h), t("./any.js")(F), t("./each.js")(F, h), t("./timers.js")(F, h), t("./filter.js")(F, h), a.toFastProperties(F), a.toFastProperties(F.prototype), x({
                                                                a: 1
                                                        }), x({
                                                                b: 2
                                                        }), x({
                                                                c: 3
                                                        }), x(1), x(function() {}), x(void 0), x(!1), x(new F(h)), v.setBounds(u.firstLineError, a.lastLineError), F
                                                }
                                        }, {
                                                "./any.js": 1,
                                                "./async.js": 2,
                                        ...
                                        38: [function(t, r, n) {
                                                ...
                                                var O = {
                                                        ...
                                                        L;
                                                O.isRecentNode = O.isNode && (L = e.versions.node.split(".").map(Number), 0 === L[0] && L[1] > 10 || L[0] > 0), O.isNode && O.toFastProperties(e);
                                                try {
                                                        throw new Error
                                                } catch (t) {
                                                        O.lastLineError = t
        ...
        834: function(t, e, r) {
                ...
                s.text = `window['_docs_force_html_by_ext'] = '${a}';window['_docs_annotate_canvas_by_ext'] = '${a}'`, document.documentElement.appendChild(s)
        }
});
